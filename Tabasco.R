...
attach(ConcTabasco) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcTabasco<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcTabasco) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcTabasco$factor,to.data.frame=TRUE)
...
ConcTabasco$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcTabasco$MAXT<-ConcTabasco$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcTabasco<-ConcTabasco[with(ConcTabasco, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcTabasco$ACUMULA<-cumsum(ConcTabasco$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcTabasco[dim(ConcTabasco[ConcTabasco$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcTabasco<-rbind(ConcTabasco[1:(dim(ConcTabasco[ConcTabasco$ACUMULA<tam_dec*i,])[1]+1),],
                     ConcTabasco[(dim(ConcTabasco[ConcTabasco$ACUMULA<tam_dec*i,])[1]+1):dim(ConcTabasco[1])[1],])
  
  b1<-tam_dec*i-ConcTabasco[dim(ConcTabasco[ConcTabasco$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcTabasco[(dim(ConcTabasco[ConcTabasco$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcTabasco[(dim(ConcTabasco[ConcTabasco$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcTabasco$ACUMULA2<-cumsum(ConcTabasco$factor)
...
ConcTabasco[(ConcTabasco$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcTabasco[((ConcTabasco$ACUMULA2>tam_dec*i)&(ConcTabasco$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcTabasco[ConcTabasco$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Tabasco")
write.dbf(ConcTabasco,file="ConcTabasco2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Tabasco")
write.dbf(ConcTabasco,file="ConcTabasco2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Tabasco")
Conc2010<-read.dbf("ConcTabasco2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Tabasco por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Tabasco por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Tabasco por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Tabasco por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Tabasco por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Tabasco INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Tabasco INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Tabasco INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Tabasco INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Tabasco INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Tabasco NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Tabasco NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Tabasco NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Tabasco NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Tabasco NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Tabasco")
Conc2018<-read.dbf("ConcTabasco2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Tabasco Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Tabasco Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Tabasco Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Tabasco Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Tabasco Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Tabasco INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Tabasco INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Tabasco INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Tabasco INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Tabasco INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Tabasco NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Tabasco NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Tabasco NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Tabasco NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Tabasco NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Tabasco por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Tabasco Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Tabasco NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Tabasco NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Tabasco INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Tabasco INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
